# Задача 1
# lst = ["Жалал-Абад", "Ош", "Бишкек", "Балыкчы", "Токмок", "Лилия", "Расстояние", "Отпусти", "Зима", "Осень", "BMW", "MERSEDES", "LEXUS", "LOTUS", "Honda"]
# print(lst[2:7])
...
# Задача 8
# music = ["Бабочка", "Вечера", "Lalala", "Dark Horse", "По уши в тебя влюблён", "Журокто", "Сурдотпочу", "Кечки Бишкек", "Жалынам", "Бегимай"]
# music[3], music[8] = music[8], music[3]
# print(music)
